"""Scrape Luscombe listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Luscombe Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=luscombe&s-original-search=luscombe",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=luscombe"),
    ("ASO", "https://aso.com/search?q=Luscombe"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Luscombe Listings</h2>
    <p>View additional Luscombe Aircraft listings at these fine sites:</p>
